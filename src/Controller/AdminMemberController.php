...
class AdminMemberController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        ->add('actions', TwigColumn::class, [
            'className' => 'id',
            'template' => 'admin_member/_partials/actions.html.twig',
            'label' => 'Actions',
            'searchable' => false
    ...
    /**
     * @Route("/admin/member/{id}", name="admin_member_update")
     */
    ...
    public function add(Request $request, EntityManagerInterface $em, UserPasswordEncoderInterface $passwordEncoder): Response
    {
        ...
        return $this->render('admin_member/update.html.twig', [
            'controller_name' => 'AdminController',
    ...
    /**
     * @Route("/admin/member/delete/{id}", name="admin_member_delete")
     */
