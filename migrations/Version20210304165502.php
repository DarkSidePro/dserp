 ...
 */
final class Version20210304165502 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE component_operation (id INT AUTO_INCREMENT NOT NULL, component_id INT NOT NULL, production_id INT DEFAULT NULL, shipment_id INT DEFAULT NULL, enter NUMERIC(10, 2) DEFAULT NULL, `exit` NUMERIC(10, 2) DEFAULT NULL, modification NUMERIC(10, 2) DEFAULT NULL, production NUMERIC(10, 2) DEFAULT NULL, shipment NUMERIC(10, 2) NOT NULL, state NUMERIC(10, 2) NOT NULL, datestamp DATETIME NOT NULL, INDEX IDX_C7783A3CE2ABAFFF (component_id), INDEX IDX_C7783A3CECC6147F (production_id), INDEX IDX_C7783A3C7BE036FC (shipment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product_operation (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, enter NUMERIC(10, 2) DEFAULT NULL, `exit` NUMERIC(10, 2) DEFAULT NULL, modification NUMERIC(10, 2) DEFAULT NULL, production NUMERIC(10, 2) DEFAULT NULL, state NUMERIC(10, 2) NOT NULL, datestamp DATETIME NOT NULL, INDEX IDX_772110E04584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE production (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, recipe_id INT NOT NULL, modification TINYINT(1) NOT NULL, datestamp DATETIME NOT NULL, INDEX IDX_D3EDB1E04584665A (product_id), INDEX IDX_D3EDB1E059D8A214 (recipe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE shipment (id INT AUTO_INCREMENT NOT NULL, datestamp DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(4096) NOT NULL, roles JSON NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
